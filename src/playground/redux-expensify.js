...
const demoState = {
    expenses: [{
        id: 'assdabsfbs',
        note: 'rent',
        description: 'for the month of jan',
        amount: 4500,
        createdAt: 0
    }],
    filters :{
...
// const expenseThree = store.dispatch(addExpense({description: 'TV', amount: 500}));
// store.dispatch(removeExpense({ id: expenseTwo.expense.id }));
// store.dispatch(editExpense(expenseThree.expense.id, {amount : 40000}));
